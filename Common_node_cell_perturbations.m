...
pert_layer(n_common).stat=pert_stat_pert.pert_data;
unpert_layer(n_common).stat=pert_stat_unpert.pert_data;

f1=figure(1);
box("on");
hold on;
pert_stat_pert.plotter("Perturbed Cell Perturbations",color(g));
ylim([-0.05 0.2]);
f2=figure(2);
box("on");
hold on;
pert_stat_unpert.plotter("Unperturbed Cell Perturbations",color(g)); 
ylim([-0.05 0.2]);
